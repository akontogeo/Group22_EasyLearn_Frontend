...
Scenario: Successfully adding a course
  Given that I am in my profile
  When I click the button "Αdd a course"
  Then I should be asked to enter the course details
  And I should be able to click the button "OK"
  And I should be informed that the course has been added Successfully
  And I should be redirected to my profile and view the new course
  
Scenario: Unsuccessfully adding a course due to empty fields
  Given that I am in my profile
  When I click the button "Αdd a course"
  Then I should be asked to enter the course details
  And I should be able to click the button "OK"
