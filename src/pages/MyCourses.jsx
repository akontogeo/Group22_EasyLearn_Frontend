...
export default function MyCourses() {
  ...
  async function handleWithdraw(courseId, courseTitle) {
    if (
      !window.confirm(
        `Are you sure you want to withdraw from "${courseTitle}"? Your progress will be lost.`
      )
    ) {
      return;
    }
    ...
    return (
      <div className="mycourses-page">
        <div className="container">
          <h1 className="page-title" data-cy="dashboard-header">
            MY COURSES
          </h1>
